...
import FragShader from "./glsl/circleNoise_A_Fragment.js"
...
btnReDelicate.addEventListener('click', () => {
    materialPlane.uniforms.delicate.value = 0.4
    inputDelicate.value = 0.4
})
...
btnReRefrec.addEventListener('click', () => {
    materialPlane.uniforms.refrac.value = 0.01
    inputRefrac.value = 0.01
})
...
btnVideoStop.addEventListener('click', () => {
    ...
    saveAs(videoBlob, 'Circle Noise A.mp4')
