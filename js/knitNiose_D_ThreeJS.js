...
import FragShader from "./glsl/knitNoise_D_Fragment.js"
...
btnReSaturate.addEventListener('click', () => {
    materialPlane.uniforms.saturate.value = 0
    inputSaturate.value = 0
})
btnReSharkX.addEventListener('click', () => {
    materialPlane.uniforms.sharkX.value = 0.1
    inputSharkX.value = 0.1
})
