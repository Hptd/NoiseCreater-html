...
import FragShader from "./glsl/cellNoise_A_Fragment.js"
...
const inputWhiteIntensity = document.querySelector("#whiteIntensity")
...
const btnReWhiteIntensity = document.querySelector("#btnReWhiteIntensity")
...
const materialPlane = new THREE.ShaderMaterial({
    ...
    uniforms: {
        ...
        whiteIntensity:{value: +inputWhiteIntensity.value},
        iTime:     {value:   +iTime},
...
params.addEventListener('input', (e) => {
    if(e.target.nodeName === "INPUT"){
        ...
        materialPlane.uniforms.whiteIntensity.value = +inputWhiteIntensity.value,
...
btnReScale.addEventListener('click', () =>{
    materialPlane.uniforms.uvScale.value = 10
    inputScele.value = 10
})
...
btnReWhiteIntensity.addEventListener('click', () => {
    materialPlane.uniforms.whiteIntensity.value = 1
    inputWhiteIntensity.value = 1
})
...
btnVideoStop.addEventListener('click', () => {
    ...
    saveAs(videoBlob, 'Cell Noise A.mp4')
