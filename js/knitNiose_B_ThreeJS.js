...
import FragShader from "./glsl/knitNoise_B_Fragment.js"
...
btnReColor2.addEventListener('click', () => {
    materialPlane.uniforms.color2.value = hexToRgb("#ffc0e6")
    inputColorChoose2.value = "#ffc0e6"
})
btnReColor3.addEventListener('click', () => {
    materialPlane.uniforms.color3.value = hexToRgb("#000000")
    inputColorChoose3.value = "#000000"
})
btnReHue.addEventListener('click', () => {
    materialPlane.uniforms.hue.value = 0.15
    inputHue.value = 0.15
})
...
btnReSharkX.addEventListener('click', () => {
    materialPlane.uniforms.sharkX.value = 0.45
    inputSharkX.value = 0.45
})
btnReSharkY.addEventListener('click', () => {
    materialPlane.uniforms.sharkY.value = 0.2
    inputSharkY.value = 0.2
})
