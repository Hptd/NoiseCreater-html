...
import FragShader from "./glsl/circleNoise_B_Fragment.js"
...
btnReColor1.addEventListener('click', () => {
    materialPlane.uniforms.color1.value = hexToRgb("#4C0F4C")
    inputColorChoose1.value = "#4C0F4C"
})
btnReColor2.addEventListener('click', () => {
    materialPlane.uniforms.color2.value = hexToRgb("#1A6680")
    inputColorChoose2.value = "#1A6680"
})
...
btnVideoStop.addEventListener('click', () => {
    ...
    saveAs(videoBlob, 'Circle Noise B.mp4')
