...
import FragShader from "./glsl/bandingGradientsFragment.js"
...
btnReBroken.addEventListener('click', () => {
    materialPlane.uniforms.broken.value = 32
    inputBroken.value = 32
})
...
btnReDelicate.addEventListener('click', () => {
    materialPlane.uniforms.delicate.value = 0.8
    inputDelicate.value = 0.8
})
...
btnVideoStop.addEventListener('click', () => {
    ...
    saveAs(videoBlob, 'banding Gradients Noise.mp4')
