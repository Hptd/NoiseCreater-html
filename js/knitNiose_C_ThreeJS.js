...
import FragShader from "./glsl/knitNoise_C_Fragment.js"
...
btnReColor1.addEventListener('click', () => {
    materialPlane.uniforms.color1.value = hexToRgb("#ff0080")
    inputColorChoose1.value = "#ff0080"
})
btnReColor2.addEventListener('click', () => {
    materialPlane.uniforms.color2.value = hexToRgb("#ffcc33")
    inputColorChoose2.value = "#ffcc33"
})
btnReHue.addEventListener('click', () => {
    materialPlane.uniforms.hue.value = 0.1
    inputHue.value = 0.1
})
...
btnReSharkX.addEventListener('click', () => {
    materialPlane.uniforms.sharkX.value = 0.25
    inputSharkX.value = 0.25
})
btnReSharkY.addEventListener('click', () => {
    materialPlane.uniforms.sharkY.value = 0.25
    inputSharkY.value = 0.25
})
