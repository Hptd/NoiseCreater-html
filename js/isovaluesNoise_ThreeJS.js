...
import FragShader from "./glsl/isovaluesNoise_Fragment.js"
...
btnReScale.addEventListener('click', () =>{
    materialPlane.uniforms.uvScale.value = 260
    inputScele.value = 260
})
...
btnReOnlyBri.addEventListener('click', () => {
    materialPlane.uniforms.onlyBri.value = 10
    inputOnlyBri.value = 10
})
...
btnReSharkX.addEventListener('click', () => {
    materialPlane.uniforms.sharkX.value = 20
    inputSharkX.value = 20
})
btnReSharkY.addEventListener('click', () => {
    materialPlane.uniforms.sharkY.value = 20
    inputSharkY.value = 20
})
...
btnVideoStop.addEventListener('click', () => {
    ...
    saveAs(videoBlob, 'isovalues Noise.mp4')
